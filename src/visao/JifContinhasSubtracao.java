 ...
 * @author Cah
 */
public final class JifContinhasSubtracao extends javax.swing.JFrame {

    int num1 = 0, num2 = 0, sub, resultado, tentativa = 0, ponto = 0, erro = 0;
    ...
    public JifContinhasSubtracao() {
        ...
        geradorNumerico();
        fazCalculo();
        // jlResultOculto.setText(String.valueOf(sub));// mostra valor da soma
    ...
    private void initComponents() {
        ...
        jlNum1.setText("0");
        getContentPane().add(jlNum1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 100, 60));

        jlSinal.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlSinal.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlSinal.setText("___");
        getContentPane().add(jlSinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 140, 50));

        jlNum2.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlNum2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlNum2.setText("0");
        getContentPane().add(jlNum2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, 100, 70));

        jlIgual.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlIgual.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlIgual.setText("-");
        getContentPane().add(jlIgual, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 100, 50));
        ...
        jlResult.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jlResultKeyReleased(evt);
            }
        });
        getContentPane().add(jlResult, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 140, 70));

        jbAvancar.setBackground(new java.awt.Color(0, 204, 0));
        jbAvancar.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jbAvancar.setText("Proximo>>");
        jbAvancar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbAvancarActionPerformed(evt);
            }
        });
        getContentPane().add(jbAvancar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, 180, 50));
        ...
        getContentPane().add(jbApagar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 100, 50));
        ...
        getContentPane().add(Pontos, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 460, 90, 30));
        ...
        jlPontos.setText("0");
        getContentPane().add(jlPontos, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 70, 30));
        ...
        jlErros.setText("0");
        getContentPane().add(jlErros, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 430, 70, 30));

        Erros.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        Erros.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Erros.setText("Erros");
        getContentPane().add(Erros, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 460, 80, 30));
        ...
        getContentPane().add(jlMensagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 400, 370, 20));
        ...
        jlTitulo.setText("Continhas de Subtração");
        getContentPane().add(jlTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, -1, -1));
        ...
        getContentPane().add(jbVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 450, 100, 40));

        jlId.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        getContentPane().add(jlId, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 40, 30));

        jlNome.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        getContentPane().add(jlNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 260, 30));
        ...
        getContentPane().add(jlFundoTela, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1650, 930));

        setSize(new java.awt.Dimension(572, 561));
    ...
    private void jbAvancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAvancarActionPerformed
        if (jlResult.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "DIGITE O RESULTADO!");
            jlResult.setText("");
            jlResult.requestFocus();
        } else {
            fazCalculo();
            // jlResultOculto.setText(String.valueOf(soma));// mostra valor da soma
            resultado = Integer.parseInt(jlResult.getText());
            comparaResultado();
            geradorNumerico();
    ...
    private void jlResultKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jlResultKeyReleased
        Integer valor;
        try {
            valor = Integer.parseInt(jlResult.getText());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(rootPane, " SÓ NUMEROS! ");
            //Limpando Campos após excluir 
            jlResult.setText("");
            jlResult.requestFocus();

        }
    }//GEN-LAST:event_jlResultKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JifContinhasSubtracao.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JifContinhasSubtracao().setVisible(true);
