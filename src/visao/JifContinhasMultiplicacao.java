 ...
 * @author Cah
 */
public final class JifContinhasMultiplicacao extends javax.swing.JFrame {

    int num1 = 0, num2 = 0, soma, resultado, tentativa = 0, ponto = 0, erro = 0;
    ...
    public JifContinhasMultiplicacao() {
    ...
    private void initComponents() {
        ...
        jlNum1.setText("0");
        getContentPane().add(jlNum1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 100, 60));

        jlSinal.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlSinal.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlSinal.setText("___");
        getContentPane().add(jlSinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 130, 50));

        jlNum2.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlNum2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlNum2.setText("0");
        getContentPane().add(jlNum2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 100, 70));

        jlIgual.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlIgual.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlIgual.setText("x");
        getContentPane().add(jlIgual, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 100, 50));
        ...
        getContentPane().add(jlResult, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 140, 70));
        ...
        getContentPane().add(jbAvancar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 180, 50));
        ...
        getContentPane().add(jbApagar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 100, 50));
        ...
        getContentPane().add(Pontos, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, 90, 30));
        ...
        jlPontos.setText("0");
        getContentPane().add(jlPontos, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 410, 70, 30));
        ...
        jlErros.setText("0");
        getContentPane().add(jlErros, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 410, 70, 30));

        Erros.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        Erros.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Erros.setText("Erros");
        getContentPane().add(Erros, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 440, 80, 30));
        ...
        getContentPane().add(jlMensagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 370, 370, 20));
        ...
        jlTitulo.setText("Continhas de Multiplicação");
        getContentPane().add(jlTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 480, -1));
        ...
        getContentPane().add(jbVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 430, 100, 40));
        ...
        getContentPane().add(jlNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 280, 30));
        ...
        setSize(new java.awt.Dimension(572, 538));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JifContinhasMultiplicacao.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JifContinhasMultiplicacao().setVisible(true);
